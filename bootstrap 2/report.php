...
$query = mysql_query('select nim, nama, alamat from data');
...
$objPHPExcel->getActiveSheet()->getStyle('E7:M7')->getFill()->getStartColor()->setARGB('FF808080');
$objPHPExcel->getActiveSheet()->getStyle('F7:I7')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
$objPHPExcel->getActiveSheet()->getStyle('F7:I7')->getFill()->getStartColor()->setARGB('FF808080');
...
$objPHPExcel->getActiveSheet()->setCellValue('E2', "PEMERINTAH KOTA BANYUWANGI");
...
$objPHPExcel->getActiveSheet()->setCellValue('E4', "SMPN 1 SONGGON");
$objPHPExcel->getActiveSheet()->mergeCells('E5:M5');
$objPHPExcel->getActiveSheet()->setCellValue('E5', "Jl. RAYA SONGGON, Telp. 123456");
$objPHPExcel->getActiveSheet()->mergeCells('E6:M6');
$objPHPExcel->getActiveSheet()->setCellValue('E6', "DATA SISWA TAHUN 2013");
